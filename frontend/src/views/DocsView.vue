<template>
  <div class="relative min-h-screen bg-biconomy-dark overflow-hidden font-sans text-biconomy-text">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 animate-fade-in-up">
      <div class="flex flex-col md:flex-row gap-8">
        ...
        <main class="flex-1 min-w-0">
          <div class="prose prose-invert max-w-none bg-biconomy-panel/60 p-8 sm:p-12 rounded-lg shadow-[0_0_15px_rgba(0,163,255,0.05)] border border-biconomy-border backdrop-blur-xl min-h-[600px]">
