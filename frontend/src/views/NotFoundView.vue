<template>
  ...
  >
    ...
    <div class="relative z-10 glass-panel max-w-lg mx-auto p-10">
      <h1 class="text-7xl font-outfit font-bold text-aa-orange mb-3">404</h1>
      <p class="text-lg text-aa-muted mb-2">
        {{ t("nav.pageNotFound", "Page not found") }}
      </p>
      <p class="text-sm text-aa-muted/70 mb-8">
        {{
          t(
            "nav.pageNotFoundDesc",
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-8">
        ...
        >
          <svg
            aria-hidden="true"
            class="w-4 h-4 flex-shrink-0 text-aa-orange/60"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
            v-html="link.icon"
...
const suggestions = [
  ...
  },
  {
    ...
    label: "nav.market",
    fallback: "Market",
    icon: '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 100 4 2 2 0 000-4z"></path>',
  },
  {
    to: "/docs",
    label: "nav.docs",
