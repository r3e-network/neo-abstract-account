      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div class="flex items-center justify-between">
          ...
          <div class="flex items-center gap-3">
            <!-- Network badge -->
            <div
              class="flex items-center gap-2 px-2.5 py-1 rounded-md bg-black border border-[#333] text-xs"
            >
              <span
            ...
            <div
              v-if="isConnected"
              class="flex items-center gap-2 px-2.5 py-1 rounded-md bg-black border border-[#333] text-xs font-mono text-[#EDEDED]"
            >
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        <div class="bg-[#0A0A0A] border border-[#333] rounded-md p-4">
          <p class="text-xs text-[#888] mb-1 font-medium">
            {{ t("console.statNetwork", "Network") }}
          </p>
          <p class="text-xl font-medium text-white">{{ networkName }}</p>
          <p class="text-xs text-[#888] mt-1">
            <span v-if="networkOnline" class="text-[#EDEDED]">{{
              t("console.networkOnline", "Online")
            }}</span>
            <span v-else-if="statusLoadFailed" class="text-[#f43f5e]">{{
        ...
        <div class="bg-[#0A0A0A] border border-[#333] rounded-md p-4">
          <p class="text-xs text-[#888] mb-1 font-medium">
            {{ t("console.statBlockHeight", "Block Height") }}
          </p>
          <p class="text-xl font-medium text-white font-mono">
            {{ blockHeight }}
          </p>
          <p class="text-xs text-[#888] mt-1">
            {{ t("console.statChainTip", "Chain tip") }}
          </p>
        </div>
        <div class="bg-[#0A0A0A] border border-[#333] rounded-md p-4">
          <p class="text-xs text-[#888] mb-1 font-medium">
            {{ t("console.statWallet", "Wallet") }}
          </p>
          ...
          <p class="text-xs text-[#888] mt-1">
            {{
              isConnected
                ? t("console.statConnected", "Connected")
                : t("console.statDisconnected", "Not connected")
            }}
          </p>
        </div>
        <div class="bg-[#0A0A0A] border border-[#333] rounded-md p-4">
          <p class="text-xs text-[#888] mb-1 font-medium">
            {{ t("console.statContract", "Contract") }}
          </p>
          <p
            class="text-base font-medium text-white font-mono truncate"
            :title="contractHashDisplay"
          >
            {{ contractHashShort }}
          </p>
          <p class="text-xs text-[#888] mt-1">
            {{ t("console.statMasterContract", "Master contract") }}
          </p>
        </div>
      </div>
      ...
      <div
        v-if="!isConnected"
        class="mb-8 bg-[#0A0A0A] border border-[#333] rounded-md p-6"
      >
        ...
        <div class="grid md:grid-cols-3 gap-6">
          <div class="flex gap-3">
            <div
              class="w-6 h-6 rounded-full border border-[#333] flex items-center justify-center text-white text-xs shrink-0 font-mono"
            >
              1
            </div>
            <div>
              <p class="text-sm font-medium text-white">
                {{ t("console.step1Title", "Connect Wallet") }}
              </p>
              <p class="text-xs text-[#888] mt-0.5">
                {{
                  t(
                    "console.step1Body",
                    "Link your Neo N3 wallet to get started",
                  )
                }}
              </p>
            </div>
          ...
          <div class="flex gap-3">
            ...
            <div>
              <p class="text-sm font-medium text-white">
                {{ t("console.step2Title", "Create Account") }}
              </p>
              <p class="text-xs text-[#888] mt-0.5">
                {{
                  t(
                    "console.step2Body",
                    "Deploy a deterministic smart wallet on Neo N3",
                  )
                }}
              </p>
            </div>
          ...
          <div class="flex gap-3">
            ...
            <div>
              <p class="text-sm font-medium text-white">
                {{ t("console.step3Title", "Add Plugins") }}
              </p>
              <p class="text-xs text-[#888] mt-0.5">
                {{
                  t(
      ...
      <!-- Service Cards Grid -->
      <h2 class="text-sm font-medium text-[#888] mb-4">
      ...
      <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
        ...
        <router-link
          to="/app"
          class="group bg-[#0A0A0A] border border-[#333] rounded-md p-5 hover:border-[#666] hover:bg-[#111] transition-all duration-200"
        >
          <div class="flex items-start gap-4">
            <div
              class="w-8 h-8 rounded border border-[#333] flex items-center justify-center shrink-0"
            >
              <svg
            ...
            <svg
              class="w-4 h-4 text-[#333] group-hover:text-[#EDEDED] transition-colors shrink-0 mt-0.5"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
        ...
        >
          <div class="flex items-start gap-4">
            ...
            <div class="flex-1 min-w-0">
              <h3 class="text-sm font-medium text-white">
                {{ t("console.serviceIdentityTitle", "Identity & DID") }}
              </h3>
              <p class="text-xs text-[#888] mt-1 leading-relaxed">
                {{
                  t(
        ...
        >
          <div class="flex items-start gap-4">
            ...
            <div class="flex-1 min-w-0">
              <h3 class="text-sm font-medium text-white">
                {{ t("console.serviceMarketTitle", "Address Market") }}
              </h3>
              <p class="text-xs text-[#888] mt-1 leading-relaxed">
                {{
                  t(
        ...
        >
          <div class="flex items-start gap-4">
            ...
            <div class="flex-1 min-w-0">
              <h3 class="text-sm font-medium text-white">
                {{ t("console.servicePluginsTitle", "Plugins & Hooks") }}
              </h3>
              <p class="text-xs text-[#888] mt-1 leading-relaxed">
                {{
                  t(
        ...
        >
          <div class="flex items-start gap-4">
            ...
            <div class="flex-1 min-w-0">
              <h3 class="text-sm font-medium text-white">
                {{ t("console.serviceDocsTitle", "Documentation") }}
              </h3>
              <p class="text-xs text-[#888] mt-1 leading-relaxed">
                {{
                  t(
                    "console.serviceDocsBody",
        ...
        >
          <div class="flex items-start gap-4">
            ...
            <div class="flex-1 min-w-0">
              <h3 class="text-sm font-medium text-white">
                {{ t("console.serviceExplorerTitle", "Block Explorer") }}
              </h3>
              <p class="text-xs text-[#888] mt-1 leading-relaxed">
                {{
                  t(
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 gap-3 mb-8">
        <router-link
          to="/app"
          class="text-center py-2.5 px-4 bg-[#000] border border-[#333] rounded-md hover:border-[#666] hover:bg-[#111] transition-all duration-200 text-xs text-[#EDEDED] font-medium"
        >
      ...
      <div class="bg-[#0A0A0A] border border-[#333] rounded-md overflow-hidden">
        <div v-if="!isConnected" class="p-8 text-center">
          <svg
            class="w-8 h-8 text-[#333] mx-auto mb-3"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
      ...
      <div
        class="mt-8 flex flex-wrap items-center justify-between gap-4 text-xs text-[#888]"
      >
        <div class="flex items-center gap-4">
          <div role="status" aria-live="polite" class="flex items-center gap-2">
            <template v-if="networkOnline">
              <span class="w-1.5 h-1.5 rounded-full bg-[#10b981]"></span>
              <span class="text-[#EDEDED] font-medium">{{
                t("console.networkOnline", "Online")
              }}</span>
              <span v-if="networkSummary" class="font-mono"
                >{{ t("console.tipPrefix", "Tip #")
                }}{{ networkSummary.chain_tip_block }}</span
              >
            </template>
            <template v-else-if="loadingStatus">
              <svg
                class="animate-spin h-3 w-3 text-[#888]"
            ...
            <template v-else-if="statusLoadFailed">
              ...
              <button
                ...
                class="text-white hover:underline transition-colors duration-200 ml-1"
              >
        ...
        <router-link
          to="/docs"
          class="text-[#888] hover:text-white transition-colors duration-200 font-medium"
        >
