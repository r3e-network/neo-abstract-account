...
const TYPE_TO_PRESENTATION = {
  ...
  did_bound: { icon: '◈', tone: 'identity', label: 'DID Bound' },
  did_notice_sent: { icon: '✉', tone: 'identity', label: 'Recovery Notice Sent' },
  recovery_requested: { icon: '⟲', tone: 'identity', label: 'Recovery Requested' },
  recovery_finalized: { icon: '✓', tone: 'identity', label: 'Recovery Finalized' },
  recovery_cancelled: { icon: '⊘', tone: 'identity', label: 'Recovery Cancelled' },
  proxy_session_requested: { icon: '⧉', tone: 'identity', label: 'Private Session Requested' },
  proxy_session_revoked: { icon: '⊗', tone: 'identity', label: 'Private Session Revoked' },
