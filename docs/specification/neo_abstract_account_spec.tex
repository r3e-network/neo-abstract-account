...
The collaboration layer stores draft-oriented coordination data rather than authorization truth. A draft \must{} be treated as a coordination artifact, not as an authority source.
...
Once verification succeeds, the master contract enforces the application policy before calling the target contract. This separation between verification and application is fundamental to the design.
