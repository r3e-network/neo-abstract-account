  ...
  <section class="card">
    ...
    <div class="space-y-8">
      ...
      <div v-if="!manageSnapshot.loadedAt" class="empty-state">
        ...
        <p class="text-sm text-aa-text font-medium mb-1">
          {{ t("studioPanels.noAccountLoaded", "No account loaded") }}
        </p>
        <p class="text-xs text-aa-muted">
          {{
            t(
              "studioPanels.loadAccountHint",
              'Enter an accountId hash above and click "Load V3 State" to get started.',
            )
          }}
        </p>
      </div>
      ...
      <transition name="fade-in-up">
        ...
        >
          ...
          >
            <div
              class="rounded-lg bg-aa-dark/40 p-3 border border-aa-border/40"
            >
              ...
              <div class="flex items-center">
                <span
                  class="font-semibold text-aa-text break-all text-xs flex-1"
                  >{{
                    manageSnapshot.accountId || t("studioPanels.unset", "unset")
                  }}</span
                >
                <button
                  v-if="manageSnapshot.accountId"
                  :aria-label="
                    t('studioPanels.copyAccountId', 'Copy AccountId')
                  "
                  @click="
                    copyText(manageSnapshot.accountId);
            ...
            >
              ...
              <div class="flex items-center">
                <span
                  class="font-semibold text-aa-text break-all text-xs flex-1"
                  >{{
                    manageSnapshot.verifier || t("studioPanels.unset", "unset")
                  }}</span
                >
                <button
                  v-if="manageSnapshot.verifier"
                  :aria-label="t('studioPanels.copyVerifier', 'Copy Verifier')"
                  @click="
                    copyText(manageSnapshot.verifier);
            ...
            >
              ...
              <div class="flex items-center">
                <span
                  class="font-semibold text-aa-text break-all text-xs flex-1"
                  >{{
                    manageSnapshot.hook || t("studioPanels.unset", "unset")
                  }}</span
                >
                <button
                  v-if="manageSnapshot.hook"
                  :aria-label="t('studioPanels.copyHook', 'Copy Hook')"
                  @click="
                    copyText(manageSnapshot.hook);
            ...
            >
              ...
              <div class="flex items-center">
                <span
                  class="font-semibold text-aa-text break-all text-xs flex-1"
                  >{{
                    manageSnapshot.backupOwner ||
                    t("studioPanels.unset", "unset")
                  }}</span
                >
                <button
                  v-if="manageSnapshot.backupOwner"
                  :aria-label="
                    t('studioPanels.copyBackupOwner', 'Copy Backup Owner')
                  "
                  @click="
                    copyText(manageSnapshot.backupOwner);
            ...
            >
              ...
              <span class="font-semibold text-aa-text text-xs"
                >{{ manageSnapshot.escapeTimelock || 0 }}
            ...
            >
              ...
              >
                {{
                  manageSnapshot.escapeActive
                    ? `${t("studioPanels.activeAt", "active @")} ${manageSnapshot.escapeTriggeredAt}`
          ...
          <div class="space-y-4">
            <div>
              ...
              <input
                ...
                v-model="manageForm.verifierContract"
                type="text"
            ...
            <div>
              ...
              <textarea
                ...
                v-model="manageForm.verifierParams"
            ...
            <button
              type="button"
              :aria-label="
                t('studioPanels.ariaUpdateVerifier', 'Update verifier')
              "
              class="btn-primary w-full"
              :class="{ 'btn-loading': manageBusy.verifier }"
              :disabled="manageBusy.verifier || !canManageTarget"
              @click="updateVerifier"
            >
              {{
                manageBusy.verifier
          ...
          <div class="space-y-4">
            <div>
              ...
              <input
                ...
                v-model="manageForm.hookContract"
                type="text"
                class="input-field font-mono text-sm py-2 px-3 bg-aa-dark"
                :placeholder="t('studioPanels.hashPlaceholder', '0x...')"
              />
            ...
            <button
              ...
              class="btn-primary w-full"
              :class="{ 'btn-loading': manageBusy.hook }"
          ...
          <div class="space-y-4">
            <div>
              ...
              <input
                ...
                v-model="metadataForm.metadataUri"
                type="text"
                class="input-field font-mono text-sm py-2 px-3 bg-aa-dark"
                :placeholder="
                  t(
              ...
              <p class="mt-1 text-xs text-aa-muted">
                {{ metadataForm.metadataUri.length }} / 240 —
                {{
                  t(
            ...
            <div>
              ...
              ></textarea>
              <p class="mt-1 text-xs text-aa-muted">
                {{ metadataForm.description.length }} / 500
              </p>
            </div>
            <div>
              <label
                ...
                >{{
                  t(
                    "studioPanels.logoUrlLabel",
                    "Logo URL (off-chain, HTTPS only)",
                  )
                }}</label
              >
            ...
            <button
              ...
              class="btn-primary w-full"
              :class="{ 'btn-loading': metadataBusy.save }"
    ...
    <transition name="fade-in-up">
      <div
        ...
        @keydown.escape="confirmModal = null"
        tabindex="-1"
      >
        <div class="modal-panel">
          ...
          <div class="flex gap-3 justify-end">
            <button class="btn-ghost" @click="confirmModal = null">
