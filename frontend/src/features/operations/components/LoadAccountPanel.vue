  ...
  <section class="glass-panel p-6">
    <div class="mb-4 flex items-center justify-between">
      <div>
        ...
        <p class="text-sm text-aa-muted">{{ t('operations.loadAccountSubtitle', 'Enter a 20-byte accountId hash. The virtual AA address is derived locally from that identity root.') }}</p>
        <p class="mt-1 text-xs text-aa-muted">{{ t('operations.loadAccountHelp', 'Enter the 40-char accountId hash captured at registration time.') }}</p>
      </div>
